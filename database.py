...
if __name__ == "__main__":
    ...
    #     type="New Group Welcome Email",
    #     subject="Welcome to TigerStudy for $COURSE$",
    #     body=(
    #         "Dear $RECIPIENT$,\n\n"
    #         "Thank you for joining TigerStudy for $COURSE$. You're the first member of your group! We will reach out to you very soon once we've matched you with other students.\n\n"
    ...
    # )
    # statement = emails.insert().values(
    #     type="Course Denied Email",
    #     subject="Course Status Update for $COURSE$",
    #     body=(
    #         "Dear Student,\n\n"
    ...
    # )
    # statement = emails.insert().values(
    #     type="Course Approved Email",
    #     subject="$COURSE$ has been approved on TigerStudy",
    #     body=(
    #         "Hello TigerStudy Friends,\n\n"
    #         "Just wanted to let you know that $COURSE$ has been approved on TigerStudy.\n\n"
    ...
    #     subject="$JOINEE$ has joined your group for $COURSE$",
    #     body=(
    #         "Hello TigerStudy Friends,\n\n"
    #         "Just wanted to let you know that $JOINEE$ has joined your student group for $COURSE$.\n\n"
    #         "Below is the contact information of everyone in your group - and we will continue to reach out to you if others join in the future. Have fun!\n\n"
    #         "$CONTACT_INFO$"
    #     ),
    # )
    ...
    #         "If you have any feedback, questions or concerns, please reach out to Nic Voge (nvoge@princeton.edu) at the McGraw Center.\n\n"
    #         "Kind Regards,\n\n"
    #         "The TigerStudy Community"
    #     ),
    # )
    # statement = emails.insert().values(
    #     type="Waiting Approval Email",
    #     subject="Thank you for signing up for $COURSE$!",
    #     body=(
    #         "This class is still pending approval from your professor. We will reach out to you as soon as we hear back from the course instructors. We appreciate your patience."
    #     ),
    # )
